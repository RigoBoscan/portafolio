<template>
  <v-container class="container-header">
    <v-app-bar color="#171717" class="header" flat app>
...
<script>
import ExploreModal from "../../components/home/ExploreModal/exploreModal.vue";
export default {
  name: "headerPortafolio",
  components: {
    ExploreModal,
  },
};
